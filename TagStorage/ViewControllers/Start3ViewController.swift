...
class Start3ViewController: UIViewController {
    
    private let imageView: UIImageView = {
        let image = UIImage(named: "start3")
    ...
    private let label: UILabel = {
        ...
        label.text = "Review Your Tags Before Your Garment Care"
